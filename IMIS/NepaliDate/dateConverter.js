...
function DateConverter() {
    ...
    this.nepaliMonths = [
        ...
        [31, 31, 31, 32, 31, 31, 30, 29, 30, 29, 30, 30], //74
        [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30], //75
        [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 30], //76
        [31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 29, 31],//77
        [31, 31, 31, 32, 31, 31, 30, 29, 30, 29, 30, 30],//78
        [31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30],//79
        [31, 32, 31, 32, 31, 30, 30, 30, 29, 29, 30, 30],//80
        [31, 32, 31, 32, 31, 30, 30, 30, 29, 30, 30, 30],//81
